...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
        ...
        <h2>Comeback Sub-Reason List</h2>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvRecords" Width="100%" runat="server" DataKeyNames="Comeback_SubReason_ID" CssClass="table table-striped table-bordered table-condensed" EmptyDataText="There are no comebacks." OnRowCommand="gvRecords_RowCommand" OnRowDeleting="gvRecords_RowDeleting1" AutoGenerateColumns="False">
                        <Columns>
...
<ControlStyle CssClass="btn btn-danger"></ControlStyle>
                            ...
                            <asp:BoundField DataField="SubReasonDescription" HeaderText="Sub-Reason Description" />
                            <asp:BoundField DataField="ReasonDescription" HeaderText="Parent Reason" />
                            <asp:CheckBoxField DataField="IsActive" Text="Active" />
                        </Columns>
                        </asp:GridView>
                    </div>
                </div>
